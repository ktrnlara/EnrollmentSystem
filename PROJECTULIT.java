...
class Registration {
 ...
 class EnrollmentGUI implements ActionListener {
    ...
    JFrame loginFrame, adminFrame, studentFrame, registrationFrame= new JFrame();
    JLabel usernameLabel, passwordLabel, firstNameLabel, lastNameLabel, emailLabel, passwordRegLabel,
           userTypeLabel, courseCodeLabel, courseNameLabel, credit = new JLabel();
